...
def _create_sakana(config: ProviderConfig, _settings: Settings) -> BaseProvider:
    from providers.sakana import SakanaProvider

    return SakanaProvider(config)
